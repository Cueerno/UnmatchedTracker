...
public class UserController {
    ...
    public ResponseEntity<Void> updatePassword(@AuthenticationPrincipal Jwt jwt, @RequestBody UpdatePasswordDto updatePasswordDto) {
        userService.updatePassword(jwt, updatePasswordDto);
